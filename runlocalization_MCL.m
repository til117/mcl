...
if nargin <7
    verbose = 2; % Verbose = 0: no visual output, 1: estimates and/or odometry and/or groundtruth, 2: (1)+ extra info, 3: (2)+ observation lines
end
if nargin<6
    start_pose = []; % global localization: start_pose = []
end
...
while 1
    count = count + 1;
    if (count > 170)&(count < 260) pause; end % To investigate convergence
